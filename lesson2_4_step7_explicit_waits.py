...
from selenium.webdriver.support.ui import WebDriverWait           # WebDriverWait - объект с правилами ожидания, для Explicit Waits
from selenium.webdriver.support import expected_conditions as EC  # expected_conditions - модуль с правилами для ожиданий, для Explicit Waits
